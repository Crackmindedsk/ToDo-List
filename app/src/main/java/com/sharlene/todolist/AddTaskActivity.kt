...
class AddTaskActivity : AppCompatActivity() {
    ...
    var timeList: ArrayList<Long>? = null
    ...
    fun setReminder(){
        ...
        timeList!!.add(delayInSeconds)
        Toast.makeText(applicationContext,"$delayInSeconds",Toast.LENGTH_SHORT).show()
        dbHelper!!.insertDelay(name.text.toString(),delayInSeconds)
